                    ...
                    if (value.WorldModel.Male.Model.AlternateTextures != null)
                    {
                        ...
                        foreach(var itm7 in value.WorldModel.Male.Model.AlternateTextures)
                        {
                            if (itm7 != null)
                            {
                                ...
                                // Index
                                writer.WritePropertyName("Index");
                                writer.WriteNumberValue(itm7.Index);
                                writer.WriteEndObject();
                            }
                            else
                            {
                    ...
                    if (value.WorldModel.Female.Model.AlternateTextures != null)
                    {
                        ...
                        foreach(var itm8 in value.WorldModel.Female.Model.AlternateTextures)
                        {
                            if (itm8 != null)
                            {
                                ...
                                // Index
                                writer.WritePropertyName("Index");
                                writer.WriteNumberValue(itm8.Index);
                                writer.WriteEndObject();
                            }
                            else
                            {
                                ...
                                case "Stages":
                                    if (reader.TokenType != JsonTokenType.Null)
                                    {
                                        ...
                                        while (true)
                                        {
                                            ...
                                            if (reader.TokenType == JsonTokenType.EndArray)
                                                break;
                                            Mutagen.Bethesda.Skyrim.DestructionStage itm12 = new Mutagen.Bethesda.Skyrim.DestructionStage();
                                            if (reader.TokenType != JsonTokenType.Null)
                                            {
                                                if (reader.TokenType != JsonTokenType.StartObject)
                                                    throw new JsonException();
                                                                        ...
                                                                        case "AlternateTextures":
                                                                            if (reader.TokenType != JsonTokenType.Null)
                                                                            {
                                                                                ...
                                                                                while (true)
                                                                                {
                                                                                    ...
                                                                                    if (reader.TokenType == JsonTokenType.EndArray)
                                                                                        break;
                                                                                    Mutagen.Bethesda.Skyrim.AlternateTexture itm16 = new Mutagen.Bethesda.Skyrim.AlternateTexture();
                                                                                    if (reader.TokenType != JsonTokenType.Null)
                                                                                    {
                                                                                        if (reader.TokenType != JsonTokenType.StartObject)
                                                                                            throw new JsonException();
                                ...
                                case "Scripts":
                                    if (reader.TokenType != JsonTokenType.Null)
                                    {
                                        ...
                                        while (true)
                                        {
                                            ...
                                            if (reader.TokenType == JsonTokenType.EndArray)
                                                break;
                                            Mutagen.Bethesda.Skyrim.ScriptEntry itm20 = new Mutagen.Bethesda.Skyrim.ScriptEntry();
                                            if (reader.TokenType != JsonTokenType.Null)
                                            {
                                                if (reader.TokenType != JsonTokenType.StartObject)
                                                    throw new JsonException();
                                                                ...
                                                                case "AlternateTextures":
                                                                    if (reader.TokenType != JsonTokenType.Null)
                                                                    {
                                                                        ...
                                                                        while (true)
                                                                        {
                                                                            ...
                                                                            if (reader.TokenType == JsonTokenType.EndArray)
                                                                                break;
                                                                            Mutagen.Bethesda.Skyrim.AlternateTexture itm26 = new Mutagen.Bethesda.Skyrim.AlternateTexture();
                                                                            if (reader.TokenType != JsonTokenType.Null)
                                                                            {
                                                                                if (reader.TokenType != JsonTokenType.StartObject)
                                                                                    throw new JsonException();
                                                                                while (true)
                                                                                {
                                                                                    ...
                                                                                    {
                                                                                        case "Name":
                                                                                            itm26.Name = reader.GetString();
                                                                                            break;
                                                                                        case "NewTexture":
                                                                                            itm26.NewTexture.SetTo(SerializerExtensions.ReadFormKeyValue(ref reader, options));
                                                                                            break;
                                                                                        case "Index":
                                                                                            itm26.Index = reader.GetInt32();
                                                                                            break;
                                                                                    }
                                                                                }
                                                                            }
                                                                            ...
                                                                            retval.WorldModel.Male.Model.AlternateTextures.Add(itm26);
                                                                        }
                                                                    }
                                                                    break;
                                                                case "File":
                                                                ...
                                                                case "AlternateTextures":
                                                                    if (reader.TokenType != JsonTokenType.Null)
                                                                    {
                                                                        ...
                                                                        while (true)
                                                                        {
                                                                            ...
                                                                            retval.WorldModel.Female.Model.AlternateTextures.Add(itm31);
                                                                        }
                                                                    }
                                                                    break;
                                                                case "File":
