...
internal static class PlacedBeam_Writer
{
    public static void WriteInner(Utf8JsonWriter writer, Mutagen.Bethesda.Skyrim.IPlacedBeamGetter? value, JsonSerializerOptions options)
    {
        if (value != null)
        {
