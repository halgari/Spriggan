...
internal static class PlacedCone_Writer
{
    public static void WriteInner(Utf8JsonWriter writer, Mutagen.Bethesda.Skyrim.IPlacedConeGetter? value, JsonSerializerOptions options)
    {
        if (value != null)
        {
