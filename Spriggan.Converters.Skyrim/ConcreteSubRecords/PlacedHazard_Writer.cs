...
internal static class PlacedHazard_Writer
{
    public static void WriteInner(Utf8JsonWriter writer, Mutagen.Bethesda.Skyrim.IPlacedHazardGetter? value, JsonSerializerOptions options)
    {
        if (value == null)
        {
            ...
            writer.WriteStringValue(value.Hazard.FormKey.ToString());
