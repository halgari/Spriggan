...
internal static class PlacedMissile_Writer
{
    public static void WriteInner(Utf8JsonWriter writer, Mutagen.Bethesda.Skyrim.IPlacedMissileGetter? value, JsonSerializerOptions options)
    {
        if (value == null)
        {
