...
internal static class PlacedFlame_Writer
{
    public static void WriteInner(Utf8JsonWriter writer, Mutagen.Bethesda.Skyrim.IPlacedFlameGetter? value, JsonSerializerOptions options)
    {
        if (value == null)
        {
