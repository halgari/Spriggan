...
internal static class PlacedTrap_Writer
{
    public static void WriteInner(Utf8JsonWriter writer, Mutagen.Bethesda.Skyrim.IPlacedTrapGetter? value, JsonSerializerOptions options)
    {
        if (value != null)
        {
