...
internal static class ScriptProperty_Writer
{
    public static void WriteOuter(Utf8JsonWriter writer, Mutagen.Bethesda.Skyrim.ScriptProperty? value, JsonSerializerOptions options)
    {
        if (value == null)
        {
