...
public class CFile
{
    ...
    public CFile(GameRelease game)
    {
        ...
        _writerEmitters = new()
        {
            ...
            (typeof(IMajorRecord), MajorRecordWriter),
        };
        ...
        _readerEmitters = new()
        {
            ...
            (typeof(MajorRecord), MajorRecordReader)
        };
    ...
    private void MajorRecordWriter(Type arg1, string arg2, Context arg3)
    {
        throw new NotImplementedException();
    }

    private void MajorRecordReader(Type arg1, string arg2, Context arg3)
    {
        throw new NotImplementedException();
    }
    ...
    private void Array2dReader(Type type, string getter, Context ctx)
    {
        ...
        SB.AppendLine($"{getter} = SerializerExtensions.Array2dReader(ref reader, ref reader => ");
        using (SB.CurlyBrace())
        {
            var itm = GetItem();
